limit_conn_zone $binary_remote_addr zone=spark0_clients:10m;
limit_req_zone $binary_remote_addr zone=spark0_requests:10m rate=100r/s;
...
server {
    ...
    location / {
        limit_conn spark0_clients 50;
        limit_req zone=spark0_requests burst=100 nodelay;
