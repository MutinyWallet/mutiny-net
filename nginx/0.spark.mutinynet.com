...
limit_req_zone $binary_remote_addr zone=spark0_req:10m rate=30r/s;
limit_req_zone $binary_remote_addr zone=spark0_authn:10m rate=5r/s;
limit_conn_zone $binary_remote_addr zone=spark0_conn:10m;

server {
    server_name 0.spark.mutinynet.com;
    set $spark_upstream grpcs://127.0.0.1:10010;
