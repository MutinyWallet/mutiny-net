...
ARG BITCOIN_VERSION="2fda7bfc027e"
ARG TARGETARCH
ARG TRIPLET
...
RUN if [ -z "$TRIPLET" ]; then \
     ...
     BITCOIN_URL="https://github.com/benthecarman/bitcoin/releases/download/mutinynet-inq-template-hash/bitcoin-${BITCOIN_VERSION}-${TRIPLET}.tar.gz" && \
